...
async function crawlSite5(index) {
    const URL = process.env[`settlement5_site${index}_URL`];
    const ID = process.env[`settlement5_site${index}_ID`];
    const PWD = process.env[`settlement5_site${index}_PWD`];
